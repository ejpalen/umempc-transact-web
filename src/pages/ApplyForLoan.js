...
const ApplyForLoan = () => {
  ...
  return (
    <div className="wrapper full-screen text-defaultn flex flex-col justify-between gap-4">
      ...
      <main className="px-4 flex-1 flex flex-col">
        ...
        <section className="flex flex-col justify-center items-center">
          <span
            ...
            className={`h-12 text-white text-bold p-2 flex-1 text-center bg-primary w-full mb-4 rounded-lg`}
          >
            Get Started
          </span>
        </section>
