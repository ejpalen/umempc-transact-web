        ...
        <span className="flex gap-2 items-center">
          ...
          <div className="flex gap-12 border-bottom py-8">
            ...
            <p className="text-bold">Total Loans Issued</p>
              <h1 className="text-3xl">₱5,000,000
              </h1>
...
const [selectedLoanApplicationStatus, setSelectedLoanApplicationStatus] = useState("Filter")
       ...
       <section className="flex items-center gap-1">
        ...
        <div
              ...
              >
                ...
                <p className={`${selectedLoanStatus === "Status" && "opacity-50"}`}>
                    {!selectedLoanStatus
                      ? "Status"
                      : selectedLoanStatus}
                  </p>
     ...
     >
       {status}
          ...
          <div
              ...
              >
                <button className="dropbtn hover-1 gap-2 w-full">
                  <p className={`${selectedLoanApplicationStatus === "Filter" && "opacity-50"}`}>
...
const LoanAgingReport = ({setSelectedFilter , selectedFilter, setSelectedNav, selectedNav }) =>{
          ...
          <section className="mt-2">
            <table>
              ...
              {loanAgingData.map((loan) => (
               ...
               <span className="flex items-center gap-1  w-max p-2 h-min rounded-md hover:bg-secondary" title="Send Reminder">
